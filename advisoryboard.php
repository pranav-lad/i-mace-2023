...
<html lang="en">
  ...
  <body>
				...
				<div class="col-md-12">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item">Advisory Board </li>
						</ol>
					</nav>
	...
	<section id="advisory" class="organizing-committee pt-3">
      <div class="head">
        <h2 class="ff" style="text-align:center">ADVISORY BOARD</h2>
        <div class="line"></div>
      ...
      <div class="row">
        ...
        <div class="cardx col">
          <div class="top">
            <h5>Dr. Amiya Kumar Tripathy</h5>
          </div>
          <div class="bottom">
            Adjunct Prof. Schhol of Science ECU Joondaleyo Campus, Australia
          </div>
        </div>
        <div class="cardx col">
          <div class="top">
        ...
        <div class="row">
          ...
          <div class="cardx col">
            <div class="top">
              <h5>Dr. Dilip Sharma</h5>
            </div>
            <div class="bottom">
              Prof., Dept. of Mechanical Engineering & Dean, Student's Welfare Malviya National I.T. Jaipur
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="cardx col">
            ...
            <div class="bottom">H’Hamed Bougara University Boumerdes, Algeria
            </div>
          </div>
        </div>
...
<!--       
    ...
    <section id="advisory2" class="organizing-committee py-4">
      <div class="head">
        <div class="line"></div>
      ...
      <div class="row">
        ...
        <div class="cardx col">
          <div class="top">
            <h5>Dr. DineshSingh G. Thakur</h5>
          </div>
          <div class="bottom">Centre for Training & Placement Defence Institute of Advanced Technology (DU), Girinagar, Pune</div>
        </div>
        <div class="cardx col">
          <div class="top">
      ...
      <!-- new added row -->
       ...
       <div class="row">
        ...
        <div class="cardx col">
          <div class="top">
            <h5>Dr. Mannawdia Shrikant</h5>
          </div>
          <div class="bottom">Vellore IOT, Chennai </div>
        </div>
        <div class="cardx col">
          <div class="top">
       ...
       <div class="row">
        ...
        <div class="cardx col">
          <div class="top">
            <h5>Dr. Prashant K. Jain</h5>
          </div>
          <div class="bottom">IIIT, Jabalpur</div>
        </div>
        <div class="cardx col">
          <div class="top">
      ...
      <div class="row">
        ...
        <div class="cardx col">
          <div class="top">
            <h5>Dr. Shanmukha Nagraj</h5>
          </div>
          <div class="bottom">RVCOE, Bengluru</div>
        </div>
        <div class="cardx col">
          <div class="top">
