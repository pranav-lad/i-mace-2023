...
<!-- End Navbar -->
    ...
    <div class="pt-2">
        <ul class="fa-ul">
          ...
          <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank" href="../vender/files/notices/TY B Tech MTE Time Table and guidelines.pdf">TY B Tech MTE Time Table and guidelines</a></li>
